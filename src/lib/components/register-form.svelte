...
<div class={cn("flex flex-col gap-6", className)} >
	<Card.Root class="overflow-hidden p-0 shadow-lg">
		<Card.Content class="grid p-0 md:grid-cols-2">
			<form class="p-6 md:p-8" bind:this={ref} {...restProps}>
				<div class="flex flex-col gap-6">
					<div class="flex flex-col items-center text-center">
						<h1 class="text-2xl font-bold">Welcome to Tycoon Game</h1>
						<p class="text-muted-foreground text-balance">
							Register your Tycoon Game account
						</p>
					</div>
					...
					<div class="grid grid-cols-3 gap-4">
						<Button variant="outline" type="button" class="w-full" title="Temporarily disabled" disabled>
			...
			<div class="bg-muted relative hidden md:block">
				<img
					...
					alt="Persona 5 illustration by ioruko"
					title="Persona 5 illustration by ioruko on deviantart"
