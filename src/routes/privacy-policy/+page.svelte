...
<div class="flex flex-col items-center justify-center min-h-full">
    ...
    <div class="prose">
        ...
        <ul>
            ...
            <li>
                <p>
                    ...
                    or &quot;Our&quot; in this Agreement) refers to Tycoon Game.
                </p>
            </li>
            <li>
                <p>
            ...
            <li>
                <p>
                    <strong>Website</strong> refers to Tycoon Game, accessible from
                    <a href="https://tycoon.aoof.ca" rel="external nofollow noopener" target="_blank"
                        >https://tycoon.aoof.ca</a
                    >
                </p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: aoof.mousa@gmail.com</li>
        </ul>
    </div>
</div>
...
<style lang="postcss">
    ...
    .prose h1 {
        @apply text-5xl font-bold mt-10 mb-6;
    }
